# =============================================================================
# Rubrik Backup Enterprise Security Group Rules (ESG 06)
# =============================================================================
...
#
# Note: Region-01 and Region-02 can reuse same priorities (600-639) because
...
locals {
  ...
  rubrik_backup_06_common = {
    "tcp-12800-12801-10-111-51-0-27-ingress" = {
      ...
      description                = "ESG 06 - Rubrik Backup Rule"
    }
  ...
  # =========================================================================
  # MERGE ALL RUBRIK BACKUP ESG 06 RULES
  # =========================================================================
