# =============================================================================
# HSA Monitoring Enterprise Security Group Rules (ESG 10)
# =============================================================================
...
#
# Note: Region-01 and Region-02 can reuse same priorities (1000-1039) because
...
locals {
  ...
  hsa_monitoring_10_common = {
    "tcp-135-10-111-41-153-32-ingress" = {
      ...
      description                = "ESG 10 - HSA Monitoring Rule"
    }
  ...
  # =========================================================================
  # MERGE ALL HSA MONITORING ESG 10 RULES
  # =========================================================================
