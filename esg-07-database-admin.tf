# =============================================================================
# Database Administration Enterprise Security Group Rules (ESG 07)
# =============================================================================
...
#
# Note: Region-01 and Region-02 can reuse same priorities (700-799) because
...
locals {
  ...
  database_admin_07_common = {
    "tcp-1433-10-110-28-197-32-ingress" = {
      ...
      description                = "ESG 07 - Database Admin Rule"
    }
  ...
  # =========================================================================
  # MERGE ALL DATABASE ADMIN ESG 07 RULES
  # =========================================================================
