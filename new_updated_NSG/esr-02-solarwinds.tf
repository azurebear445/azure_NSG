...
locals {
  ...
  solarwinds_02_common = var.enable_enterprise_security_rules ? {
  ...
  solarwinds_02_region_01 = var.enable_enterprise_security_rules ? {
  ...
  solarwinds_02_region_02 = var.enable_enterprise_security_rules ? {
