# =============================================================================
# Multi-Service Enterprise Security Group Rules (ESG 05)
# =============================================================================
...
#
# Note: Region-01 and Region-02 can reuse same priorities (500-599) because
...
locals {
  ...
  multi_service_05_common = {
    "tcp-22-10-110-88-0-24-ingress" = {
      ...
      description                = "ESG 05 - Multi-Service Rule"
    }
  ...
  # =========================================================================
  # MERGE ALL MULTI-SERVICE ESG 05 RULES
  # =========================================================================
