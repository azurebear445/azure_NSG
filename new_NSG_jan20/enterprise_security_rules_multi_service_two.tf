...
locals {
  ...
  multi_service_two_common = {
    ...
    "Allow-MultiService_TCP_135_In_2" = {
      direction                  = "Inbound"
      access                     = "Allow"
      priority                   = 407
      protocol                   = "Tcp"
    ...
    "Allow-MultiService_TCP_135_In_3" = {
      direction                  = "Inbound"
      access                     = "Allow"
      priority                   = 408
      protocol                   = "Tcp"
    ...
    "Allow-MultiService_TCP_135_In_4" = {
      direction                  = "Inbound"
      access                     = "Allow"
      priority                   = 409
      protocol                   = "Tcp"
    ...
    "Allow-MultiService_TCP_135_In_5" = {
      direction                  = "Inbound"
      access                     = "Allow"
      priority                   = 410
      protocol                   = "Tcp"
    ...
    "Allow-MultiService_TCP_139_In_2" = {
      direction                  = "Inbound"
      access                     = "Allow"
      priority                   = 413
      protocol                   = "Tcp"
    ...
    "Allow-MultiService_TCP_139_In_3" = {
      direction                  = "Inbound"
      access                     = "Allow"
      priority                   = 414
      protocol                   = "Tcp"
    ...
    "Allow-MultiService_TCP_139_In_4" = {
      direction                  = "Inbound"
      access                     = "Allow"
      priority                   = 415
      protocol                   = "Tcp"
    ...
    "Allow-MultiService_TCP_139_In_5" = {
      direction                  = "Inbound"
      access                     = "Allow"
      priority                   = 416
      protocol                   = "Tcp"
    ...
    "Allow-MultiService_TCP_443_In_2" = {
      direction                  = "Inbound"
      access                     = "Allow"
      priority                   = 419
      protocol                   = "Tcp"
    ...
    "Allow-MultiService_TCP_636_In_2" = {
      direction                  = "Inbound"
      access                     = "Allow"
      priority                   = 428
      protocol                   = "Tcp"
    ...
    "Allow-MultiService_TCP_636_In_3" = {
      direction                  = "Inbound"
      access                     = "Allow"
      priority                   = 429
      protocol                   = "Tcp"
    ...
    "Allow-MultiService_TCP_1858_In" = {
      direction                  = "Inbound"
      access                     = "Allow"
      priority                   = 430
      protocol                   = "Tcp"
    ...
    "Allow-MultiService_TCP_1858_In_1" = {
      direction                  = "Inbound"
      access                     = "Allow"
      priority                   = 431
      protocol                   = "Tcp"
    ...
    "Allow-MultiService_TCP_1858_In_2" = {
      direction                  = "Inbound"
      access                     = "Allow"
      priority                   = 432
      protocol                   = "Tcp"
    ...
    "Allow-MultiService_TCP_1858_In_3" = {
      direction                  = "Inbound"
      access                     = "Allow"
      priority                   = 433
      protocol                   = "Tcp"
    ...
    "Allow-MultiService_TCP_3389_In_1" = {
      direction                  = "Inbound"
      access                     = "Allow"
      priority                   = 435
      protocol                   = "Tcp"
    ...
    "Allow-MultiService_TCP_3389_In_2" = {
      direction                  = "Inbound"
      access                     = "Allow"
      priority                   = 436
      protocol                   = "Tcp"
    ...
    "Allow-MultiService_TCP_3389_In_3" = {
      direction                  = "Inbound"
      access                     = "Allow"
      priority                   = 437
      protocol                   = "Tcp"
    ...
    "Allow-MultiService_TCP_5500_In" = {
      direction                  = "Inbound"
      access                     = "Allow"
      priority                   = 438
      protocol                   = "Tcp"
    ...
    "Allow-MultiService_TCP_5500_In_1" = {
      direction                  = "Inbound"
      access                     = "Allow"
      priority                   = 439
      protocol                   = "Tcp"
    ...
    "Allow-MultiService_TCP_5500_In_2" = {
      direction                  = "Inbound"
      access                     = "Allow"
      priority                   = 440
      protocol                   = "Tcp"
    ...
    "Allow-MultiService_TCP_5500_In_3" = {
      direction                  = "Inbound"
      access                     = "Allow"
      priority                   = 441
      protocol                   = "Tcp"
    ...
    "Allow-MultiService_TCP_49152to65535_In_4" = {
      direction                  = "Inbound"
      access                     = "Allow"
      priority                   = 446
      protocol                   = "Tcp"
    ...
    "Allow-MultiService_TCP_49152to65535_In_5" = {
      direction                  = "Inbound"
      access                     = "Allow"
      priority                   = 447
      protocol                   = "Tcp"
    ...
    "Allow-MultiService_TCP_52731_In_4" = {
      direction                  = "Inbound"
      access                     = "Allow"
      priority                   = 452
      protocol                   = "Tcp"
    ...
    "Allow-MultiService_TCP_52731_In_5" = {
      direction                  = "Inbound"
      access                     = "Allow"
      priority                   = 453
      protocol                   = "Tcp"
    ...
    "Allow-MultiService_UDP_1813_In" = {
      direction                  = "Inbound"
      access                     = "Allow"
      priority                   = 454
      protocol                   = "Udp"
    ...
    "Allow-MultiService_UDP_1813_In_1" = {
      direction                  = "Inbound"
      access                     = "Allow"
      priority                   = 455
      protocol                   = "Udp"
    ...
    "Allow-MultiService_UDP_1813_In_2" = {
      direction                  = "Inbound"
      access                     = "Allow"
      priority                   = 456
      protocol                   = "Udp"
    ...
    "Allow-MultiService_UDP_1813_In_3" = {
      direction                  = "Inbound"
      access                     = "Allow"
      priority                   = 457
      protocol                   = "Udp"
